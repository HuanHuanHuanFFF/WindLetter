# Wind Letter v1 Java 基础库开发文档（v0.1）
...
- 文档名称：Wind Letter v1 Java 基础库开发文档
- 版本：v0.1
...
- 提供统一的编码工具：
  - Base64URL 编解码；
  - WindBase1024F 编解码（可分阶段实现：v0.1 只需定义接口与占位实现，内部可以暂时调用 Base64URL）；
- 为 Armor 与 JSON 字段服务。
...
本开发文档对应 **Java 基础库 v0.1**，建议后续迭代方向：
