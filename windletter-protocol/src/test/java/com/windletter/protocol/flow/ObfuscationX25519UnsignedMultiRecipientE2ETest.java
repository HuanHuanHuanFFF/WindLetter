...
class ObfuscationX25519UnsignedMultiRecipientE2ETest {
    ...
    void realBouncyCastleRepresentativeBucketsAuthenticateFinalWireOrder(
        ...
        try (Fixture fixture = new Fixture()) {
            ...
            try {
                ...
                String wire = fixture.send(payload, handles);
    ...
    static Stream<BucketCase> representativeBuckets() {
        return Stream.of(
                new BucketCase(3, 8, PayloadKind.BINARY, false),
                new BucketCase(9, 16, PayloadKind.TEXT, false),
                new BucketCase(17, 32, PayloadKind.EMPTY, true)
        );
    }
